...
```powershell
msiexec /i "WindowsTiler-0.1.0-x64.msi" /qn /norestart
msiexec /fa "WindowsTiler-0.1.0-x64.msi" /qn /norestart
msiexec /x "WindowsTiler-0.1.0-x64.msi" /qn /norestart
```
...
```powershell
.\scripts\build-msi.ps1 -Version 0.1.1 -OutputDirectory .local/upgrade-fixture
.\scripts\test-msi.ps1 -MsiPath artifacts/installer/WindowsTiler-0.1.0-x64.msi -UpgradeMsiPath .local/upgrade-fixture/WindowsTiler-0.1.1-x64.msi
```
